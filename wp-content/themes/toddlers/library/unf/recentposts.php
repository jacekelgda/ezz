...
function unf_excerptlength_grid() {
	$output = substr(get_the_excerpt(), 0,500);
...
$params['tax_query']	= array(
			        array(
			            ...
			            'field' => 'slug',
			            'terms' => array( 'post-format-aside', 'post-format-quote', 'post-format-video', 'post-format-link', 'post-format-chat', 'post-format-image', 'post-format-gallery'),
			            'operator' => 'NOT IN'
			        )
			    );
